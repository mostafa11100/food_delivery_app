...
import '../../../../controler/auth/signin&&signupfloder/verifycodeemail.dart';
import '../../../../core/function/alertdialogpop.dart';

class verifyemailcode extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    veryficodeemailcontrolapp controler = Get.put(veryficodeemailcontrolapp());
    return Scaffold(
        body: WillPopScope(
      onWillPop: alertpop,
      child: Container(
